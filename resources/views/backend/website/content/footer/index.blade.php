                        ...
                        <form action=" {{route('backend-footer.update', $footer->id)}} " method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <label for="basicInput">No Telepon</label> <span class="text-danger">*</span>
                                        <input type="number" class="form-control @error('telp') is-invalid @enderror" name="telp" value="{{$footer->telp}}" />
                                        @error('telp')
                                            <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                            </div>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <label for="basicInput">No WhatsApp</label> <span class="text-danger">*</span>
                                        <input type="number" class="form-control @error('whatsapp') is-invalid @enderror" name="whatsapp" value="{{$footer->whatsapp}}"/>
                                        @error('whatsapp')
                                            <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                            </div>
