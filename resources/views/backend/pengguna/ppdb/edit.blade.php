            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('linkedln') is-invalid @enderror" name="linkedln" value="{{$user->userDetail->linkedln}}" placeholder="Linkedln" />
                                        @error('linkedln')
                                            <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                            </div>
                        ...
                        <form action="{{ route('backend-pengguna-ppdb.resetPassword', $user->id) }}" method="POST">
                            @csrf
