<div class="video-area overlay-video bg-common-style" style="background-image: url({{asset('Assets/Frontend/img/banner/1.jpg')}});">
    <div class="container">
        <div class="video-content">
            ...
            <a class="play-btn popup-youtube wow bounceInUp" data-wow-duration="2s" data-wow-delay=".1s" href="https://youtu.be/TTvL7HZKzpc"><i class="fa fa-play" aria-hidden="true"></i></a>
        </div>
    </div>
</div>
