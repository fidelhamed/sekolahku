                                            ...
                                            @foreach ($murid as $key => $murids)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a data-id="{{ $murids->id }}" id="updatePerbaikan" class="btn btn-danger btn-sm" style="display: {{ $murids->role !== 'Guest' || $murids->berkas->kartu_keluarga == null || $murids->muridDetail->proses == 'Perbaikan' ? 'none' : ''}}">Perbaikan</a>
